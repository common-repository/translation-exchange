        ...
        <div style="float:right; color:#888;">
            <?php if (get_option("tml_cache_type") == "none") {
                ...
                <a href="#" onclick="useCache('none', '0')"
                   style="text-decoration: none"><?php _e("use") ?></a>
            <?php } ?>

            <div class="help" style="display: inline-block; margin-left: 10px;">
                ?
                <div class="tooltip">
                    <?php _e("When user visits your WordPress pages, the translation cache will be loaded directly from Translation Exchange CDN and stored in the user's browser for better performance.") ?>
                </div>
            </div>
        </div>
