...
<div style="border: 1px solid #ccc; width: 100%; margin-bottom: 10px;">
    <div style="background:#fefefe; padding: 5px; border-bottom: 1px solid #ccc;">
        <div style="float:right; color:#888;">
            ...
            <div class="help" style="display: inline-block; margin-left: 10px;">
                ?
                <div class="tooltip">
                    Shared cache is used to accommodate multiple installations of WordPress. It automatically
                    synchronizes with
    ...
    <div style="padding: 5px;">
        <table style="width:100%; font-size:12px;" cellspacing="0" cellpadding="0">
                ...
                if (get_option('tml_cache_adapter') == 'memcached') {
                    try {
                        ...
                        if (!isset($status[$key]) || $status[$key]['uptime'] == 0) {
                            $error = "Memcached connection information is invalid.";
                        }
                    } catch (Exception $e) {
                        $error = "Memcached connection information is invalid.";
                    }
                    ...
                    try {
                        ...
                        if (!$status) {
                            $error = "Memcache connection information is invalid.";
                        }
                    } catch (Exception $e) {
                        $error = "Memcache connection information is invalid.";
                    }
                    ...
                    try {
                        ...
                        $error = "Redis connection information is invalid.";
                    }
                }
            }
            ?>
            ...
            <tr>
                ...
                <td style="">
                    <select id="tml_cache_adapter" style="width:100%;" disabled>
                        ...
                        <?php if (class_exists('Memcache')) { ?>
                            <option
                                value="memcache" <?php if (get_option("tml_cache_adapter") == "memcache") echo "selected"; ?>>
                                Memcache
                            </option>
                        <?php } ?>
            ...
            <tr>
                ...
                <td style="">
                    <input type="text" id="tml_cache_port" disabled value="<?php echo(get_option("tml_cache_port")) ?>"
                           placeholder="11211" style="width:100%">
                </td>
                <td style="padding-left: 10px;">
                    <div class="help">
                        ?
            ...
            <tr>
                ...
                <td style="">
                    <input type="text" id="tml_cache_namespace" disabled
                           value="<?php echo(get_option("tml_cache_namespace", "wordpress")) ?>"
                           placeholder="11211" style="width:100%">
                </td>
                <td style="padding-left: 10px;">
                    <div class="help">
            ...
            <tr>
                ...
                <td style="">
                    <input type="text" id="tml_cache_version_check_interval" disabled
                           ...
                           placeholder="Interval in seconds" style="width:100%">
                </td>
                <td style="padding-left: 10px;">
                    <div class="help">
                        ?
