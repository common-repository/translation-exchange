...
<h2>
    ...
    <?php echo __('Translation Exchange with Polylang'); ?>
...
<div class="info" style="background: white; text-align:center">
    <div>
        <img
            src="<?php echo plugin_dir_url(__FILE__) . "../../../../assets/images/confirmations/polylang.png" ?>"
            >
    </div>
    ...
    <div style="padding-top: 10px;">
        Translation Exchange has been successfully configured to be used with your Polylang plugin. <br>
...
<div style="background: white; padding: 10px; border-radius: 5px; text-align: center">
    <div style="text-align: center">
        <img
            src="<?php echo plugin_dir_url(__FILE__) . "../../../../assets/images/plugins/polylang.png" ?>"
            class="logo">

        <h3 style="color: #666">See Polylang and Translation Exchange in action in the video below.</h3>

        <div style="margin-top: 20px;margin-bottom: 20px;">
            <div class="screen">
                <iframe class="youtube" width="560" height="315" src="https://www.youtube.com/embed/k073eqiltew"
                        frameborder="0"
