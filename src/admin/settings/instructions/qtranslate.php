...
<h2>
    ...
    <?php echo __('Translation Exchange with qTranslate X'); ?>
...
<div class="info" style="background: white; text-align:center">
    <div>
        <img
            src="<?php echo plugin_dir_url(__FILE__) . "../../../../assets/images/confirmations/qtranslate-x.png" ?>"
            >
    </div>
    ...
    <div style="padding-top: 10px;">
        Translation Exchange has been successfully configured to be used with your qTranslate X plugin. <br>
...
<div style="background: white; padding: 10px; border-radius: 5px; text-align: center">
    <div style="text-align: center">
        ...
        <h3 style="color: #666">See qTranslate X and Translation Exchange in action in the video below.</h3>

        <div style="margin-top: 20px;margin-bottom: 20px;">
            <div class="screen">
                <iframe class="youtube" width="560" height="315" src="https://www.youtube.com/embed/tTlmsqOjsRY"
                        frameborder="0"
